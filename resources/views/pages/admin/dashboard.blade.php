          ...
          >
            <div class="container-fluid">
              <div class="dashboard-heading">
                ...
                <p class="dashboard-subtitle">toko admin</p>
              </div>
              ...
              <div class="row mt-3">
                  <div class="col-12 mt-2">
                    ...
                    @foreach ($transaction_data as $transaction)
                      ...
                      href="{{ route('dashboard-transactions-details-admin', $transaction->id) }}"
                    >
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-1">{{ ($transaction->transaction->id) }}</div>
                          <div class="col-md-1">
                            <img
